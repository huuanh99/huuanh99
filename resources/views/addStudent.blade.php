...
<body>
	<div class="center-container">
		...
		<div class="header-w3l">
			<h1><a href="http://localhost:8080/project1">ADD STUDENT</a> </h1>
					</div>
		<!--//header-->
		<!--main-->
    ...
    <form action="{{ route('student.store') }}" method="post">
        @csrf
				...
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					<span>Điểm toán :</span>
					<input type="number" name="toan" required=""/>
					<div class="clear"> </div>
				</div>
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					<span>Điểm lý :</span>
					<input type="number" name="ly" required=""/>
					<div class="clear"> </div>
				</div>
				<div class="w3_modal_body_grid w3_modal_body_grid1">
					<span>Điểm hóa :</span>
					<input type="number" name="hoa" required=""/>
					<div class="clear"> </div>
				</div>
